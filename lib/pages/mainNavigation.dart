  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          backgroundColor:
              Colors.grey, // Cambia el color de fondo de la barra de navegación
          selectedItemColor:
              Colors.grey, // Cambia el color de los iconos activos
          unselectedItemColor:
              Colors.grey, // Cambia el color de los iconos inactivos
          items: [
